...
## 更新摘要
**所做更改**   
- 更新了标题栏组件，新增下拉菜单系统和导出功能访问入口
- 增强了用户界面交互体验，提供更直观的菜单操作方式
- 优化了工具按钮的组织结构，将相关功能整合到下拉菜单中
...
**更新** 本次更新重点反映了标题栏组件的下拉菜单系统增强：新增了包含导出功能在内的下拉菜单，提供了更直观和便捷的用户操作体验。
...
participant Title as "Titlebar<br/>主题/语言控制/下拉菜单"
...
User->>Shell : 打开应用
Shell->>Title : 渲染标题栏含主题/语言控制/下拉菜单
...
### 应用外壳 AppShell
- 视觉与布局
  - 顶部标题栏（含主题和语言控制、下拉菜单）、中部主内容区（编辑器+侧边栏）、底部状态栏（含源代码模式切换）。
...
- 与布局交互：面板切换影响编辑器可用宽度；主题切换影响编辑器配色；语言切换影响 UI 文案；**源代码模式切换影响编辑器显示模式；下拉菜单操作可能触发编辑器相关功能。**
- 性能：增量渲染、防抖保存、懒加载插件。
...
**更新** 本次重构显著提升了用户体验：标题栏新增的下拉菜单系统为用户提供了更加直观和便捷的操作方式，特别是导出功能的快速访问。主题和语言切换功能保持在标题栏，使常用操作更加便捷；源代码模式切换保持在状态栏，提供了更直观的编辑模式切换。这些改进使得界面布局更加合理，操作流程更加顺畅。
